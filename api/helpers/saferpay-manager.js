    ...
    fn: async function(inputs, exits) {
        ...
        if (inputs.type && inputs.type == "assert") {
            if (selectedOrder.saferpay) {
                let saferpay = JSON.parse(selectedOrder.saferpay);
                var fields = {
                    "RequestHeader": {
                        "SpecVersion": "1.21",
                        "CustomerId": "257381",
            ...
            var fields = {
                ...
                "ReturnUrls": {
                    "Success": `http://bydotpy.com/d-event/POS/pos-preview/${inputs.pos_id}/` + inputs.order_id + "/success",
                    "Fail": `http://bydotpy.com/d-event/POS/pos-preview/${inputs.pos_id}/` + inputs.order_id + "/failed",
                    "Abort": `http://bydotpy.com/d-event/POS/pos-preview/${inputs.pos_id}/` + inputs.order_id + "/abort"
                }
            };
